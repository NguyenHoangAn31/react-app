...
const handleSignup = async () => {
  ...
  window.confirmationResult
    ...
    .then(async (res) => {
      try {
        console.log(data);
        const result = await axios.post(`https://spring-api-w8iy.onrender.com/api/user/register`, data);
        if(result){
...
const hanldeSendOtp = async () => {
  const result = await axios.get(`https://spring-api-w8iy.onrender.com/api/user/search/${phone}`);
