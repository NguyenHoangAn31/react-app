...
function ProfileDoctor() {
  ...
  useEffect(() => {
    const fetchDoctorData = async () => {
      try {
        const response = await axios.get(`https://spring-api-w8iy.onrender.com/api/doctor/findbyuserid/${currentUser.user.id}`); // cái này là tìm doctor theo id chứ k phải tìm theo user_id
