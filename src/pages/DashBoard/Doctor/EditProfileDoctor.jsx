...
const EditProfileDoctor = () => {
    ...
    const updateDoctor = async (e) => {
        ...
        try {
            const res = await axios.put('https://spring-api-w8iy.onrender.com/api/doctor/update/' + id, doctor);
    ...
    const handleEditWorking = async (id) => {
        try {
            const result = await axios.get('https://spring-api-w8iy.onrender.com/api/working/' + id);
            const newWorking = {
                id: result.data.id,
    ...
    const handleEditQualification = async (id) => {
        try {
            const result = await axios.get('https://spring-api-w8iy.onrender.com/api/qualification/' + id);
