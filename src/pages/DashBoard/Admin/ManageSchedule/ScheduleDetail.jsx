      ...
      <div data-aos="fade-up">
        ...
        <Tabs
          ...
          items={clinic.departments.map((deptValue, i) => {
            const id = String(i + 1);
            return {
              label: <div className='d-flex gap-3'><img src={"https://spring-api-w8iy.onrender.com/images/department/" + deptValue.icon} width='20' />{deptValue.name}   </div>,
              key: id,
              children: <Tabs
                tabPosition={tabPosition}
                defaultActiveKey={null}
                        ...
                        optionRender={(option) => (
                          <Space>
                            <span role="img" aria-label={option.data.fullName}>
                              <img src={"https://spring-api-w8iy.onrender.com/images/doctors/" + option.data.image} alt="" style={{ width: 30, height: 30, objectFit: 'cover', borderRadius: '50%', objectPosition: 'top' }} />
                      ...
                      <Slider {...{
                        ...
                        {slot.doctorsForSchedules.map((doctor, doctorIndex) => (
                          <div key={doctorIndex} className='text-center'>
                            <img src={"https://spring-api-w8iy.onrender.com/images/doctors/" + doctor.image} alt="" style={{ backgroundImage: 'linear-gradient(120deg, rgb(161, 196, 253) 0%, rgb(194, 233, 251) 100%)', width: 200, display: 'block', margin: 'auto' }} />
