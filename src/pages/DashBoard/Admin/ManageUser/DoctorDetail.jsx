      ...
      <div className='doctor_detail_dashboard'>
        ...
        <div className='doctor_info' style={{ display: 'flex', width: '90%', margin: 'auto', gap: '40px'}}>
          ...
          <div className='dotor_image_dashboard text-center' style={{maxWidth:350,margin:'0 auto'}}>
            {!Object.keys(doctor).length == 0 && doctor.image != null ? <img src={"https://spring-api-w8iy.onrender.com/images/doctors/" + doctor.image} style={{width:'100%', backgroundImage: "linear-gradient(120deg, #a1c4fd 0%, #c2e9fb 100%)" }} /> : null}
