    ...
    <div className='patient_detail_dashboard'>
      ...
      <div className='patient_info' style={{ display: 'flex', width: '90%', margin: 'auto', gap: '40px' }}>
        ...
        <div className='patient_image_dashboard' style={{maxWidth:350,margin:'auto'}}>
          {!Object.keys(patient).length == 0 && patient.image != null ? <img src={"https://spring-api-w8iy.onrender.com/images/patients/" + patient.image} style={{ width:'100%',backgroundImage: "linear-gradient(120deg, #a1c4fd 0%, #c2e9fb 100%)" }} /> : null}
