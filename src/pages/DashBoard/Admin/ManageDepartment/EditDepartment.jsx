...
function EditDepartment() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, { image }) => {
        return (
          image ? <img src={"https://spring-api-w8iy.onrender.com/images/doctors/" + image} width="50" alt="" /> : null);
      },
            ...
            <Select placeholder="Select Status" onChange={(e) => onInputChangeForDepartment('status', e)} >
              ...
              {department.icon ?
                <Form.Item label="Icon">
                  <Image
                    width={100}
                    src={"https://spring-api-w8iy.onrender.com/images/department/" + department.icon}
                  /></Form.Item> : <></>
              }
