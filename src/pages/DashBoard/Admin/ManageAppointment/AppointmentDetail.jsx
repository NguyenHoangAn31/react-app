            ...
            <div className='flex-grow-1'>
              <div className='mb-5'>
                ...
                <div className='appointment-patient d-flex gap-3'>
                  <div>
                    <img src={"https://spring-api-w8iy.onrender.com/images/doctors/" + appointmentDetail.doctor.image} alt="" width='200' style={{ backgroundImage: 'linear-gradient(120deg, rgb(161, 196, 253) 0%, rgb(194, 233, 251) 100%)' }} />
                  </div>
                  <div className='mt-2'>
                    <div>
              ...
              <div>
                ...
                <div className='d-flex appointment-doctor gap-3'>
                  <div>
                    <img src={"https://spring-api-w8iy.onrender.com/images/patients/" + appointmentDetail.patient.image} alt="" width='200' />
