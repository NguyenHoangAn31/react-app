...
const BlogDetail = () => {
  ...
  const fetchNewsItem = async () => {
    try {
      const response = await axios.get(`https://spring-api-w8iy.onrender.com/api/news/${id}`);
  ...
  const fetchSuggestNew = async () => {
    try {
      const response = await axios.get('https://spring-api-w8iy.onrender.com/api/news/all');
